 ...
 */
taoensso.sente.interfaces.IPacker = (function (){var obj30619 = {};
return obj30619;
})();
...
return (function (){var or__23236__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__23872__auto__)]);
if(or__23236__auto__){
return or__23236__auto__;
} else {
var or__23236__auto____$1 = (taoensso.sente.interfaces.pack["_"]);
...
var x__23872__auto__ = (((_ == null))?null:_);
return (function (){var or__23236__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__23872__auto__)]);
if(or__23236__auto__){
return or__23236__auto__;
} else {
var or__23236__auto____$1 = (taoensso.sente.interfaces.unpack["_"]);
if(or__23236__auto____$1){
return or__23236__auto____$1;
} else {
...
taoensso.sente.interfaces.EdnPacker.cljs$lang$ctorPrWriter = (function (this__23815__auto__,writer__23816__auto__,opt__23817__auto__){
return cljs.core._write.call(null,writer__23816__auto__,"taoensso.sente.interfaces/EdnPacker");
});
...
return G__30621.taoensso$sente$interfaces$IPacker$;
}
})())){
return true;
} else {
if((!G__30621.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__30621);
} else {
return false;
}
}
