...
if(!((function (){var G__31380 = app_db;
if(G__31380){
...
return G__31380.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__31380.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__31380);
} else {
return false;
}
}
...
while (G__31385__i < G__31385__a.length) {G__31385__a[G__31385__i] = arguments[G__31385__i + 0]; ++G__31385__i;}
  args = new cljs.core.IndexedSeq(G__31385__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__31386){
var args = cljs.core.seq(arglist__31386);
...
return cljs.core.get_in.call(null,new_db,p1__31387_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__31388_SHARP_){
return cljs.core.get_in.call(null,db,p1__31388_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__31389__i = 0, G__31389__a = new Array(arguments.length -  2);
while (G__31389__i < G__31389__a.length) {G__31389__a[G__31389__i] = arguments[G__31389__i + 2]; ++G__31389__i;}
  in_paths = new cljs.core.IndexedSeq(G__31389__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__31390){
var f = cljs.core.first(arglist__31390);
arglist__31390 = cljs.core.next(arglist__31390);
var out_path = cljs.core.first(arglist__31390);
var in_paths = cljs.core.rest(arglist__31390);
