(ns frejm.api
  (:require [frejm.html :as html]
            ;[frejm.animals :as animals]
            ;[frejm.books :as books]
            ;[frejm.db :as db]
            ;[liberator.core :refer (resource)]
            [compojure.core :refer (defroutes ANY)]
            [compojure.route :refer (resources not-found)]
            [ring.middleware.params :refer (wrap-params)]
            [ring.aiddleware.edn :refer (wrap-edn-params)]
...
;  (ANY "/animals/:id" [id name species]
